export default function generateCustomXMark(color = '#000000', size = 25) {
  const svgNamespace = 'http://www.w3.org/2000/svg';

  const svg = document.createElementNS(svgNamespace, 'svg');
  svg.setAttribute('version', '1.0');
  svg.setAttribute('xmlns', 'http://www.w3.org/2000/svg');
  svg.setAttribute('width', `${size}pt`);
  svg.setAttribute('height', `${size * (1135 / 1280)}pt`);
  svg.setAttribute('viewBox', '0 0 1280.000000 1135.000000');
  svg.setAttribute('preserveAspectRatio', 'xMidYMid meet');

  const g = document.createElementNS(svgNamespace, 'g');
  g.setAttribute(
    'transform',
    'translate(0.000000,1135.000000) scale(0.100000,-0.100000)',
  );
